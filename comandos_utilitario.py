...
class MapButton(ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view.mapas_status[self.mapa_arquivo] = not view.mapas_status[self.mapa_arquivo]
...
class VermintideView(ui.View):
    def __init__(self, mapas):
        ...
        self.mapas_status = {m: True for m in mapas}
    ...
    async def sortear_callback(self, interaction: discord.Interaction):
        ...
        embed_vitoria.set_footer(text="Os ventos da magia se dissipam...\nEsta visão perecerá em 15 segundos.")
        ...
        msg_sorteio = await interaction.original_response()
        
        await asyncio.sleep(15)
        try:
            await msg_sorteio.delete()
        except:
            pass
